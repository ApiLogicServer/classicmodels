...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.02.10, August 16, 2023 17:22:08):
...
app_logger.info(f'Created August 16, 2023 17:22:08 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.02.10\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.02.10\n'
    if is_docker():
