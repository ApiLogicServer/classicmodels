...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.02.10, August 16, 2023 20:47:01):
...
app_logger.info(f'Created August 16, 2023 20:47:01 at {str(current_path)}\n')
