...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.04.00, October 01, 2023 06:34:17):
...
app_logger.info(f'Created October 01, 2023 06:34:17 at {str(current_path)}\n')
