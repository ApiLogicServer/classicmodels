...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.02.10, August 16, 2023 09:07:25):
...
app_logger.info(f'Created August 16, 2023 09:07:25 at {str(current_path)}\n')
